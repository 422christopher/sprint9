...
# the @ is a "decorator." It adds functionality to the following lines of code
# so @pytest.fixture does many lines of code we do not see
@pytest.fixture
def empty_wallet():
    return Wallet()
...
def test_empty_wallet(empty_wallet): # We don't need line below with pytest fixture argument
    # empty_wallet = Wallet()
